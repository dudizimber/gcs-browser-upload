...
const BufferProcessor_1 = require("./BufferProcessor");
...
class BufferUpload {
    constructor(args, allowSmallChunks = false) {
        ...
        const opts = Object.assign({ chunkSize: MIN_CHUNK_SIZE, storage: (_a = args.storage) !== null && _a !== void 0 ? _a : (() => {
            ...
            })(), contentType: "text/plain", onChunkUpload: () => {
                /** */
            }, id: null, url: null, buffer: null, metadata: null }, args);
        ...
        (0, debug_1.default)(` - File size: ${opts.buffer.byteLength}`);
        (0, debug_1.default)(` - Chunk size: ${opts.chunkSize}`);
        this.opts = opts;
        this.meta = new FileMeta_1.FileMeta(opts.id, opts.buffer.byteLength, opts.chunkSize, opts.storage);
        this.processor = new BufferProcessor_1.BufferProcessor(opts.buffer, opts.chunkSize);
